...
const Products = () => {
  ...
  if (loading) return (
    <div className="max-w-7xl mx-auto px-4 md:px-6 py-12 animate-pulse">
      ...
      <div className="flex gap-10">
        ...
        <div className="flex-1 grid grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8">
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc]">
      ...
      <div className={`fixed right-0 top-0 h-full w-70 bg-white z-120 p-6 shadow-2xl transition-transform duration-300 md:hidden ${isFilterOpen ? "translate-x-0" : "translate-x-full"}`}>
        ...
        <div className="flex flex-col gap-6 mb-10">
          <div className="flex justify-between items-center">
            ...
            <button 
              ...
              className="md:hidden flex items-center gap-2 bg-white border border-slate-200 px-4 py-2.5 rounded-xl font-bold text-sm shadow-sm"
            >
          ...
          {/* SORTING BAR */}
          <div className="flex items-center justify-between bg-white p-2 md:p-3 rounded-2xl border border-slate-100 shadow-sm">
